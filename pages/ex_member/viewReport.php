				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<a href='../../pages/ex_member/manageReport.php' class='btn btn-info btn-icon-text'><i class='ti-arrow-left btn-icon-prepend'></i> Back</a>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							...
							<img width='400' height='400' src="<?php echo $tempFeesEvidence; ?>" readonly>
