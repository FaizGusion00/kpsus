				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<a href='../../pages/ex_member/manageMember.php' class='btn btn-info btn-icon-text'><i class='ti-arrow-left btn-icon-prepend'></i> Back</a>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							...
							<img width='400' height='400' src="<?php echo $tempPic; ?>">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" value="<?= $tempMemberUsername ?>" readonly>
										</div>
										<label for="exampleInputPassword2" class="col-sm-3 col-form-label">Password</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" value="<?= $tempMemberPassword ?>" readonly>
										</div>
