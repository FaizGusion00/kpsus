...
if (isset($_POST['submitEdit'])) {
	...
	if ($_FILES["inPicture"]["name"] == null) {
		...
		if (!$query2) {
			...
			echo "<script>alert('Update Member Information Succesfully'); window.open('../../pages/ex_member/manageMember.php','_self'); </script>";
		}
							...
							<div class="card">
								<div class="card-body">
									<form class="forms-sample" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
										...
										<a class="btn btn-light" href='manageMember.php'>Cancel</a>
									</form>
