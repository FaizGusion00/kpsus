						...
						<div class="col-md-12 grid-margin">
							<div class="row">
								<div class="col-12 col-xl-8 mb-4 mb-xl-0">
									<h3 class="font-weight-bold">Welcome Executive Member : <?php echo $_SESSION['user_name']; ?></h3>
								...
								<div class="col-12 col-xl-4">
									...
									<script>
										...
										document.getElementById("current_date").innerHTML = " Today : " + today;
									</script>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-6 mb-4 stretch-card transparent">
									<div class="card card-tale">
										<div class="card-body">
											<p class="mb-4">Total Ex-Member</p>
											<p class="fs-30 mb-2"><?php $sql = "SELECT * FROM member";
																						...
																						echo $count; ?></p>
											<p>Limit of Executive Member is 5</p>
										</div>
									</div>
								</div>
								<div class="col-md-6 mb-4 stretch-card transparent">
									<div class="card card-dark-blue">
										<div class="card-body">
											...
											<p class="fs-30 mb-2"><?php $sql = "SELECT * FROM event";
																						$query = mysqli_query($conn, $sql);
																						$count = 1;
																						foreach ($query as $row) {
																							$count++;
																						...
																						echo $count; ?></p>
											<p>All Event Details will show at Event Description</p>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
									<div class="card card-light-blue">
										<div class="card-body">
											<p class="mb-4">Total of Member</p>
											<p class="fs-30 mb-2"><?php $sql = "SELECT * FROM member";
																						$query = mysqli_query($conn, $sql);
																						$count = 0;
																						foreach ($query as $row) {
																						...
																						echo $count; ?></p>
											<p>All member and executive member in KPSUS</p>
										</div>
									</div>
								</div>
								<div class="col-md-6 stretch-card transparent">
									<div class="card card-light-danger">
										<div class="card-body">
											<p class="mb-4">Total Fees Collected</p>
											<p class="fs-30 mb-2"><?php $sql = "SELECT * FROM fees";
																						$query = mysqli_query($conn, $sql);
																						$countFees = 0;
																						foreach ($query as $row) {
																							$countFees = (float)$row['feesAmount'] + $countFees;
																						}
																						echo $countFees; ?></p>
											<p>Fees Colledted based on all type fees provided</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<p class="font-weight-500">The total number of fees collected within the date range. It is the period date a user is actively engaged with your website, page or app, etc</p>
									<div class="d-flex flex-wrap mb-5">
										<div class="mr-5 mt-3">
											<p class="text-muted">Total Fees value</p>
											<h3 class="text-primary fs-30 font-weight-medium"><?= $countFees ?></h3>
										</div>
										<div class="mr-5 mt-3">
											<p class="text-muted">Total User Pay</p>
											<h3 class="text-primary fs-30 font-weight-medium"><?php $sql = "SELECT * FROM fees";
																																				$query = mysqli_query($conn, $sql);
																																				$count1 = 0;
																																				foreach ($query as $row) {
																																					$count1++;
																																				...
																																				echo ($count1."/".$count2); ?></p>
											</h3>
										</div>
										<div class="mr-5 mt-3">
											<p class="text-muted">Percentage Payment User</p>
											<h3 class="text-primary fs-30 font-weight-medium"><?php 
											if($count1==0 || $count2 ==0){
												echo "0%";
											}else{
												$total=$count2/$count1 * 100; echo $total."%";
											}
											 ?></h3>
										</div>
										<!-- <div class="mt-3">
							...
							<div class="card">
								<div class="card-body">
									<div class="d-flex justify-content-between">
										<p class="card-title">Fees Report by Month</p>
										<!-- <a href="#" class="text-info">View all</a> -->
									</div>
									<p class="font-weight-500">The total fees of month sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
