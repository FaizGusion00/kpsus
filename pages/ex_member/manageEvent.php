							...
							<div class="card">
								<div class="card-body">
									<div class="d-flex justify-content-between">
										...
										<button class="btn btn-primary" data-target="#exampleModalScrollable" data-toggle="modal"><i class="mdi mdi-plus"></i> Add Event</button>
									...
									<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
										<div class="modal-dialog modal-dialog-scrollable" role="document">
												...
												<form method="POST" action="" class="pt-3" name="eventForm">
													...
													<div class="modal-body">
														<div class="form-group">
															...
															<input type="text" name="inEventID" class="form-control" id="inEventID" placeholder="ex : EV001" required>
														</div>
														<div class="form-group">
															<label for="inEventName">Event Name</label>
															<input type="text" class="form-control" id="inEventName" name="inEventName" placeholder="ex : Silat Training BootCamp" required>
														</div>
														<div class="form-group">
															<label for="inEventDesc">Event Description</label>
															<textarea class="form-control" id="inEventDesc" name="inEventDesc" placeholder="ex : This event is about" rows="3" required></textarea>
														</div>
													</div>
											...
											if (isset($_POST['submitEvent'])) {
												$eventID = $_POST['inEventID'];
												$eventName = $_POST['inEventName'];
												$eventDesc = $_POST['inEventDesc'];

												$sql = "INSERT INTO event (eventID,eventName,eventDesc) VALUES ('$eventID','$eventName','$eventDesc')";

												$query = mysqli_query($conn, $sql);

												if ($query) {
													echo "<script>alert('Event Add Success')</script>";
												} else {
													$msg = $conn->error;
															...
															foreach ($query as $row) {
																...
																"<tr>
																	...
																	<td>
																		...
																		<a href='editEvent.php?event_update_id={$row['eventID']}' class='btn btn-warning'><i class='ti-file btn-icon-prepend'></i>  Edit
																		</a>
																				
																		<a onclick='return confirmDelete(this);' href='deleteEvent.php?event_delete_id={$row['eventID']}' class='btn btn-danger'><i class='ti-trash btn-icon-prepend'></i>  Delete
																		</a>
																	</td> 
																</tr>\n";
															}
