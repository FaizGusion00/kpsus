...
if (isset($_POST['submitEdit'])) {
	...
	if (!$query2) {
		...
		echo "<script>alert('Update Event Succesfully'); window.open('../../pages/ex_member/manageEvent.php','_self'); </script>";
	}
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Edit Event Information</h4>
									<form class="forms-sample" method="POST" action="">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="edEvName" name="edEvName" value="<?php echo $tempEventName ?>" required>
										</div>
										<div class="form-group">
											<label for="edEvDesc">Event Description</label>
											<textarea class="form-control" id="edEvDesc" name="edEvDesc" rows="3" required><?php echo $tempEventDesc ?></textarea>
										</div>
										<input type="submit" name="submitEdit" class="btn btn-primary mr-2" value="Update"></input>
										<a class="btn btn-light" href='manageEvent.php'>Cancel</a>
									</form>
								</div>
							</div>
						</div>
