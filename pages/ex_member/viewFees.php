...
<head>
	...
	<title>KPSU Exeutive Member Panel</title>
	<!-- plugins:css -->
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<a href='../../pages/ex_member/manageFees.php' class='btn btn-info btn-icon-text'><i class='ti-arrow-left btn-icon-prepend'></i> Back</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<label for="exampleInputUsername2" class="col-sm-3 col-form-label">Fees Date</label>
										<div class="col-sm-9">
