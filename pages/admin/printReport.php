...
class myPDF extends FPDF
{
	...
	{
		$this->SetFont('Times', '', 12);
		$sql = "SELECT fees.feesEvidence,fees.feesType,fees.feesDate,fees.feesAmount,member.memberName,member.memberMatricID,member.dateJoined FROM fees INNER JOIN member ON fees.memberMatricID=member.memberMatricID";
